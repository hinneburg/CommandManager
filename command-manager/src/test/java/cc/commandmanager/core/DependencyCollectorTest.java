...
public class DependencyCollectorTest {
	...
	this.dependencyCollector.updateDependencies("command", dependencies, afterDependencies, beforeDependencies);
	...
	this.dependencyCollector.updateDependencies("command_allready2", dependencies, afterDependencies,
		beforeDependencies);
