...
public final class MissingCatalogAttributeException extends RuntimeException {

	private static final long serialVersionUID = -8375366289082678959L;

	public MissingCatalogAttributeException(String documentUri, String elementName, int attributePosition,
