...
/**
 * This class is used for the controlled execution of commands. Commands to be executed are declared in an catalog.
 * Those commands will be ordered and then executed.
 * <p>
